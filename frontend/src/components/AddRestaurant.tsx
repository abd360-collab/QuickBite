  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-6">
        <div className="mx-auto max-w-lg rounded-xl bg-white p-6 shadow-sm space-y-5">
           ...
           <label className="flex cursor-pointer items-center gap-3 rounded-lg border p-4 text-sm text-gray-600 hover:bg-gray-500"><BiUpload className="h-5 w-5 text-red-500" />
           {image? image.name : "Upload your restaurant image"}
