...
//     This code is creating a countdown timer of 10 seconds.
// Every second → it decreases the timer
// When timer reaches 0 → it automatically calls onAccepted()
    useEffect(()=> {
  ...
  return (
    <div className="rounded-xl bg-white p-4 shadow-sm border border-green-300
    space-y-3">
        <p className="text-center text-xs font-semibold 
        text-red-600">Accept Within {secondsLeft} </p>


        <p className="text-center text-xs font-semibold 
        text-green-600">New Delivery request</p>
