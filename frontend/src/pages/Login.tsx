...
const Login = () => {
    ...
    // This function runs after Google login success/failure.
    // authResult -> given by google.
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-white px-4">
        <div className="w-full max-w-sm space-y-6">
            ...
            <button onClick={googleLogin} disabled={loading} className="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-300 bg-white px-4 py-3 cursor-pointer">
